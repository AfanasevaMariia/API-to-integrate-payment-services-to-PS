...
public class CoreFormatterModuleApplication {
	...
	public static void main(String[] args) throws IOException, ISOException {
		...
		String message = isoMessageService.toString()
		...
		String hex = "00000000000800000000000001000000165E303130333131315E30333033313135"; // LL before the 48th field.
		System.out.println("myMessage = " + hex);
		...
		String hexAccepted = hex;
		Router router = new Router();
		// This is that will be sent to routing module back.
		ParsedMessage parsedMessage = router.getParsedMessage(hexAccepted);
		// For encoding.
		String hexToSend = router.getHex(parsedMessage);
		// ----------------------------------------------------------------------------------------
	}
